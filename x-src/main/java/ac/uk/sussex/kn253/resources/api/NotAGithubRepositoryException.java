...
public class NotAGithubRepositoryException extends WebApplicationException {
    ...
    private static final String DEFAULT_DETAIL = "repository is not linked to GitHub";
    private static final String MESSAGE_TEMPLATE = "Path '%s' cannot be resolved to a GitHub repository (%s)";
